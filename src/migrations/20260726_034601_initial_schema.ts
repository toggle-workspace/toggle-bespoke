...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "services_process_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"order" numeric,
  ...
  CREATE TABLE "services" (
  	...
  	"icon_id" integer,
  	"title" varchar,
  	"deliverables_section_title" varchar,
  ...
  ALTER TABLE "case_studies" ADD CONSTRAINT "case_studies_client_id_client_id_fk" FOREIGN KEY ("client_id") REFERENCES "public"."client"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "client" ADD CONSTRAINT "client_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "services_deliverables_items" ADD CONSTRAINT "services_deliverables_items_icon_id_media_id_fk" FOREIGN KEY ("icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "services_process_items" ADD CONSTRAINT "services_process_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."services"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "client_logo_idx" ON "client" USING btree ("logo_id");
  CREATE INDEX "client_industry_idx" ON "client" USING btree ("industry_id");
  CREATE INDEX "client_updated_at_idx" ON "client" USING btree ("updated_at");
  CREATE INDEX "client_created_at_idx" ON "client" USING btree ("created_at");
  ...
  CREATE INDEX "services_deliverables_items_icon_idx" ON "services_deliverables_items" USING btree ("icon_id");
  CREATE INDEX "services_process_items_order_idx" ON "services_process_items" USING btree ("_order");
  CREATE INDEX "services_process_items_parent_id_idx" ON "services_process_items" USING btree ("_parent_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_client_id_idx" ON "payload_locked_documents_rels" USING btree ("client_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "services_process_items" CASCADE;
